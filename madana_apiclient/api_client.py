...
from madana_apiclient import rest
from madana_apiclient.configuration import Configuration
from madana_apiclient.exceptions import ApiTypeError, ApiValueError, ApiException
from madana_apiclient.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.activate_user  # this is an instance of the class Endpoint
        api_instance.activate_user()  # this invokes api_instance.activate_user.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.activate_user.callable or self.callable in this class
