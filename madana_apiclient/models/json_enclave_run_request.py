...
class JsonEnclaveRunRequest(object):
    ...
    def __init__(self, environment_uuid=None, using_default_run_config=None, enclave_execution_type=None, wireguard_public_key=None, local_vars_configuration=None):  # noqa: E501
