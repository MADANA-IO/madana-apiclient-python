...
class JsonEnclaveRunRequest(object):
    ...
    def __init__(self, using_default_run_config=None, wireguard_public_key=None, enclave_execution_type=None, environment_uuid=None, local_vars_configuration=None):  # noqa: E501
