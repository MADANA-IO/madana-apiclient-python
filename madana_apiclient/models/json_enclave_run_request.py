...
class JsonEnclaveRunRequest(object):
    ...
    def __init__(self, enclave_execution_type=None, using_default_run_config=None, environment_uuid=None, wireguard_public_key=None, local_vars_configuration=None):  # noqa: E501
