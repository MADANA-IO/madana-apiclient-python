...
class JsonEnvironment(object):
    ...
    def __init__(self, roothash=None, uuid=None, published=None, ipfs_hash=None, packages=None, default_run_configuration=None, content=None, size=None, root_hash_offset=None, description=None, name=None, local_vars_configuration=None):  # noqa: E501
