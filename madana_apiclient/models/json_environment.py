...
class JsonEnvironment(object):
    ...
    def __init__(self, uuid=None, packages=None, content=None, roothash=None, description=None, default_run_configuration=None, ipfs_hash=None, size=None, name=None, published=None, root_hash_offset=None, local_vars_configuration=None):  # noqa: E501
