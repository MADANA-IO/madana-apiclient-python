...
class JsonEnvironment(object):
    ...
    def __init__(self, uuid=None, description=None, default_run_configuration=None, root_hash_offset=None, ipfs_hash=None, packages=None, published=None, roothash=None, name=None, content=None, size=None, local_vars_configuration=None):  # noqa: E501
