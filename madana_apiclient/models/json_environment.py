...
class JsonEnvironment(object):
    ...
    def __init__(self, description=None, published=None, roothash=None, size=None, default_run_configuration=None, ipfs_hash=None, packages=None, root_hash_offset=None, name=None, uuid=None, content=None, local_vars_configuration=None):  # noqa: E501
