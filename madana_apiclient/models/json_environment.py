...
class JsonEnvironment(object):
    ...
    def __init__(self, packages=None, default_run_configuration=None, name=None, content=None, size=None, ipfs_hash=None, uuid=None, published=None, roothash=None, root_hash_offset=None, description=None, local_vars_configuration=None):  # noqa: E501
