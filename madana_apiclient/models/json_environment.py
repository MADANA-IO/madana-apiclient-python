...
class JsonEnvironment(object):
    ...
    def __init__(self, ipfs_hash=None, published=None, packages=None, content=None, uuid=None, root_hash_offset=None, roothash=None, name=None, default_run_configuration=None, size=None, description=None, local_vars_configuration=None):  # noqa: E501
