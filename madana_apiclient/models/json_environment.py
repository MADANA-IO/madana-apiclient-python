...
class JsonEnvironment(object):
    ...
    def __init__(self, size=None, name=None, uuid=None, root_hash_offset=None, content=None, default_run_configuration=None, ipfs_hash=None, roothash=None, published=None, packages=None, description=None, local_vars_configuration=None):  # noqa: E501
