...
class JsonEnvironment(object):
    ...
    def __init__(self, roothash=None, name=None, root_hash_offset=None, published=None, ipfs_hash=None, uuid=None, content=None, size=None, description=None, default_run_configuration=None, packages=None, local_vars_configuration=None):  # noqa: E501
