...
class JsonEnvironment(object):
    ...
    def __init__(self, description=None, root_hash_offset=None, uuid=None, name=None, published=None, roothash=None, default_run_configuration=None, size=None, content=None, packages=None, ipfs_hash=None, local_vars_configuration=None):  # noqa: E501
