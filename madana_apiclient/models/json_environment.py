...
class JsonEnvironment(object):
    ...
    def __init__(self, ipfs_hash=None, size=None, content=None, roothash=None, packages=None, name=None, root_hash_offset=None, default_run_configuration=None, description=None, published=None, uuid=None, local_vars_configuration=None):  # noqa: E501
