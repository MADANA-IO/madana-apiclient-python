...
class JsonEnvironment(object):
    ...
    def __init__(self, packages=None, published=None, ipfs_hash=None, roothash=None, default_run_configuration=None, description=None, root_hash_offset=None, content=None, size=None, uuid=None, name=None, local_vars_configuration=None):  # noqa: E501
