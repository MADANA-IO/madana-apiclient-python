...
class JsonEnvironmentPublishingRequest(object):
    ...
    def __init__(self, uuid=None, name=None, size=None, packages=None, content=None, description=None, ipfs_hash=None, is_public=None, ipfs_primary_peer=None, local_vars_configuration=None):  # noqa: E501
