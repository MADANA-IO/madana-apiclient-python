...
class JsonEnvironmentPublishingRequest(object):
    ...
    def __init__(self, size=None, description=None, name=None, is_public=None, ipfs_primary_peer=None, packages=None, ipfs_hash=None, uuid=None, content=None, local_vars_configuration=None):  # noqa: E501
