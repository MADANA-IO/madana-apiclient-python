...
class JsonEnvironmentPublishingRequest(object):
    ...
    def __init__(self, packages=None, size=None, ipfs_hash=None, name=None, content=None, is_public=None, uuid=None, description=None, ipfs_primary_peer=None, local_vars_configuration=None):  # noqa: E501
