...
class JsonEnvironmentPublishingRequest(object):
    ...
    def __init__(self, size=None, ipfs_hash=None, content=None, name=None, description=None, uuid=None, is_public=None, packages=None, ipfs_primary_peer=None, local_vars_configuration=None):  # noqa: E501
