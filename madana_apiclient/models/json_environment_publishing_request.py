...
class JsonEnvironmentPublishingRequest(object):
    ...
    def __init__(self, ipfs_hash=None, content=None, size=None, packages=None, description=None, name=None, uuid=None, is_public=None, ipfs_primary_peer=None, local_vars_configuration=None):  # noqa: E501
