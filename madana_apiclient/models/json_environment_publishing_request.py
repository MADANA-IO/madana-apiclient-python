...
class JsonEnvironmentPublishingRequest(object):
    ...
    def __init__(self, size=None, content=None, description=None, is_public=None, name=None, ipfs_hash=None, uuid=None, ipfs_primary_peer=None, packages=None, local_vars_configuration=None):  # noqa: E501
