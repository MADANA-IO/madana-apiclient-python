...
class JsonEnvironmentPublishingRequest(object):
    ...
    def __init__(self, ipfs_hash=None, name=None, ipfs_primary_peer=None, content=None, size=None, is_public=None, description=None, packages=None, uuid=None, local_vars_configuration=None):  # noqa: E501
