...
class JsonEnvironmentPublishingRequest(object):
    ...
    def __init__(self, content=None, uuid=None, size=None, is_public=None, name=None, ipfs_primary_peer=None, description=None, ipfs_hash=None, packages=None, local_vars_configuration=None):  # noqa: E501
