...
class JsonEnvironmentPublishingRequest(object):
    ...
    def __init__(self, size=None, content=None, name=None, ipfs_primary_peer=None, packages=None, is_public=None, uuid=None, description=None, ipfs_hash=None, local_vars_configuration=None):  # noqa: E501
