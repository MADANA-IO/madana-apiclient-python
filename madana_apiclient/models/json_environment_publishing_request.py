...
class JsonEnvironmentPublishingRequest(object):
    ...
    def __init__(self, ipfs_hash=None, ipfs_primary_peer=None, description=None, uuid=None, content=None, packages=None, is_public=None, name=None, size=None, local_vars_configuration=None):  # noqa: E501
