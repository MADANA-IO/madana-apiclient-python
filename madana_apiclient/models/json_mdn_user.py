...
class JsonMDNUser(object):
    ...
    def __init__(self, image=None, created=None, user_name=None, last_active=None, activated=None, last_name=None, mail=None, guid=None, credentials=None, social_accounts=None, first_name=None, settings=None, local_vars_configuration=None):  # noqa: E501
