...
class JsonMDNUser(object):
    ...
    def __init__(self, created=None, image=None, activated=None, last_active=None, user_name=None, last_name=None, social_accounts=None, first_name=None, settings=None, mail=None, credentials=None, guid=None, local_vars_configuration=None):  # noqa: E501
