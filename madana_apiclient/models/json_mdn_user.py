...
class JsonMDNUser(object):
    ...
    def __init__(self, user_name=None, activated=None, created=None, last_active=None, image=None, credentials=None, guid=None, settings=None, last_name=None, mail=None, social_accounts=None, first_name=None, local_vars_configuration=None):  # noqa: E501
