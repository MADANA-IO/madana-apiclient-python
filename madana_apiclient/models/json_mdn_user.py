...
class JsonMDNUser(object):
    ...
    def __init__(self, user_name=None, created=None, last_active=None, activated=None, image=None, social_accounts=None, first_name=None, guid=None, last_name=None, credentials=None, settings=None, mail=None, local_vars_configuration=None):  # noqa: E501
