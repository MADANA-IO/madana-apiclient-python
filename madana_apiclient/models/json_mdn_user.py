...
class JsonMDNUser(object):
    ...
    def __init__(self, last_active=None, image=None, user_name=None, created=None, activated=None, first_name=None, mail=None, credentials=None, guid=None, settings=None, last_name=None, social_accounts=None, local_vars_configuration=None):  # noqa: E501
