...
class JsonMDNUser(object):
    ...
    def __init__(self, last_name=None, credentials=None, settings=None, mail=None, guid=None, first_name=None, social_accounts=None, local_vars_configuration=None):  # noqa: E501
