...
class JsonMDNUser(object):
    ...
    def __init__(self, last_active=None, user_name=None, created=None, activated=None, image=None, social_accounts=None, guid=None, last_name=None, settings=None, first_name=None, credentials=None, mail=None, local_vars_configuration=None):  # noqa: E501
