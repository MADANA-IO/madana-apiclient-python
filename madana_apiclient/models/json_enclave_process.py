...
class JsonEnclaveProcess(object):
    ...
    def __init__(self, wireguard_public_key=None, public_ident=None, enclave_inputstream=None, status=None, internal_ident=None, internal_remote_control_server=None, internal_wireguard_server=None, ending_time=None, startup_cmd=None, enclave_ident=None, remote_control_server=None, wireguard_server=None, startup_time=None, console_output=None, environment=None, process=None, wg_interface=None, internal_attesation_server=None, signer_ident=None, attestation_server=None, local_vars_configuration=None):  # noqa: E501
