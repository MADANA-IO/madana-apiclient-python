...
class JsonEnclaveProcess(object):
    ...
    def __init__(self, startup_time=None, environment=None, internal_remote_control_server=None, status=None, startup_cmd=None, remote_control_server=None, signer_ident=None, internal_ident=None, enclave_ident=None, enclave_inputstream=None, public_ident=None, wireguard_public_key=None, ending_time=None, attestation_server=None, process=None, internal_attesation_server=None, console_output=None, wg_interface=None, local_vars_configuration=None):  # noqa: E501
