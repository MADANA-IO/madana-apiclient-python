...
class JsonEnclaveProcess(object):
    ...
    def __init__(self, environment=None, internal_attesation_server=None, process=None, console_output=None, status=None, internal_wireguard_server=None, wireguard_public_key=None, startup_cmd=None, remote_control_server=None, enclave_ident=None, internal_ident=None, ending_time=None, startup_time=None, wg_interface=None, signer_ident=None, wireguard_server=None, enclave_inputstream=None, internal_remote_control_server=None, attestation_server=None, public_ident=None, local_vars_configuration=None):  # noqa: E501
