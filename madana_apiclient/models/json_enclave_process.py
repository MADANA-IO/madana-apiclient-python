...
class JsonEnclaveProcess(object):
    ...
    def __init__(self, startup_time=None, remote_control_server=None, enclave_ident=None, internal_ident=None, startup_cmd=None, signer_ident=None, wireguard_public_key=None, environment=None, internal_remote_control_server=None, process=None, attestation_server=None, internal_attesation_server=None, console_output=None, ending_time=None, status=None, wg_interface=None, enclave_inputstream=None, local_vars_configuration=None):  # noqa: E501
