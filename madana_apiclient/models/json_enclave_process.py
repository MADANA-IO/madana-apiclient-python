...
class JsonEnclaveProcess(object):
    ...
    def __init__(self, startup_time=None, internal_remote_control_server=None, wireguard_public_key=None, console_output=None, enclave_ident=None, signer_ident=None, ending_time=None, remote_control_server=None, attestation_server=None, environment=None, process=None, status=None, startup_cmd=None, enclave_inputstream=None, internal_ident=None, internal_attesation_server=None, wg_interface=None, local_vars_configuration=None):  # noqa: E501
