...
class JsonEnclaveProcess(object):
    ...
    def __init__(self, environment=None, wireguard_public_key=None, startup_cmd=None, status=None, enclave_inputstream=None, process=None, console_output=None, internal_ident=None, attestation_server=None, remote_control_server=None, ending_time=None, wg_interface=None, signer_ident=None, enclave_ident=None, internal_attesation_server=None, internal_remote_control_server=None, startup_time=None, local_vars_configuration=None):  # noqa: E501
