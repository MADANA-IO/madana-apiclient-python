...
class JsonEnclaveProcess(object):
    ...
    def __init__(self, ending_time=None, process=None, wireguard_server=None, startup_time=None, enclave_inputstream=None, remote_control_server=None, internal_ident=None, startup_cmd=None, environment=None, status=None, internal_remote_control_server=None, console_output=None, enclave_ident=None, signer_ident=None, attestation_server=None, wg_interface=None, internal_attesation_server=None, wireguard_public_key=None, public_ident=None, internal_wireguard_server=None, local_vars_configuration=None):  # noqa: E501
