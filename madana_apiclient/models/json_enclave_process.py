...
class JsonEnclaveProcess(object):
    ...
    def __init__(self, startup_cmd=None, internal_wireguard_server=None, signer_ident=None, process=None, remote_control_server=None, internal_ident=None, environment=None, wireguard_server=None, ending_time=None, attestation_server=None, wg_interface=None, startup_time=None, status=None, enclave_ident=None, console_output=None, internal_remote_control_server=None, public_ident=None, internal_attesation_server=None, enclave_inputstream=None, wireguard_public_key=None, local_vars_configuration=None):  # noqa: E501
