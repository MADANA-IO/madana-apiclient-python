...
class JsonEnclaveProcess(object):
    ...
    def __init__(self, internal_wireguard_server=None, startup_cmd=None, internal_attesation_server=None, enclave_ident=None, wg_interface=None, signer_ident=None, status=None, process=None, wireguard_server=None, ending_time=None, internal_ident=None, enclave_inputstream=None, wireguard_public_key=None, public_ident=None, console_output=None, attestation_server=None, remote_control_server=None, startup_time=None, internal_remote_control_server=None, environment=None, local_vars_configuration=None):  # noqa: E501
