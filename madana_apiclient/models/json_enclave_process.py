...
class JsonEnclaveProcess(object):
    ...
    def __init__(self, wireguard_server=None, wireguard_public_key=None, environment=None, startup_time=None, startup_cmd=None, internal_ident=None, status=None, signer_ident=None, internal_wireguard_server=None, enclave_inputstream=None, process=None, ending_time=None, internal_remote_control_server=None, enclave_ident=None, remote_control_server=None, public_ident=None, internal_attesation_server=None, console_output=None, wg_interface=None, attestation_server=None, local_vars_configuration=None):  # noqa: E501
