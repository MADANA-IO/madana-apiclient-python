...
class JsonIPFSSystemInfo(object):
    ...
    def __init__(self, agent_version=None, id=None, protocol_version=None, swarm_connection=None, public_key=None, local_vars_configuration=None):  # noqa: E501
