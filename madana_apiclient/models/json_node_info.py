...
class JsonNodeInfo(object):
    ...
    def __init__(self, cpu_physical_cores=None, connection_url=None, memory=None, processors=None, cpu_frequency=None, ipfs_info=None, public_key=None, hardware_baseboard=None, cpu_logical_count=None, owner=None, operating_system_uptime=None, cpu_family=None, hardware_firmware=None, status=None, operating_system=None, cpu_model=None, local_vars_configuration=None):  # noqa: E501
