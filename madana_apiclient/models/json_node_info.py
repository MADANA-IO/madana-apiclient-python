...
class JsonNodeInfo(object):
    ...
    def __init__(self, connection_url=None, public_key=None, cpu_physical_cores=None, hardware_firmware=None, ipfs_info=None, owner=None, processors=None, cpu_model=None, status=None, cpu_frequency=None, hardware_baseboard=None, memory=None, cpu_logical_count=None, operating_system=None, operating_system_uptime=None, cpu_family=None, local_vars_configuration=None):  # noqa: E501
