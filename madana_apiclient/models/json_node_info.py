...
class JsonNodeInfo(object):
    ...
    def __init__(self, operating_system_uptime=None, ipfs_info=None, cpu_family=None, processors=None, cpu_frequency=None, operating_system=None, owner=None, status=None, cpu_physical_cores=None, cpu_model=None, memory=None, hardware_firmware=None, public_key=None, connection_url=None, hardware_baseboard=None, cpu_logical_count=None, local_vars_configuration=None):  # noqa: E501
