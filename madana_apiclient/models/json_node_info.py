...
class JsonNodeInfo(object):
    ...
    def __init__(self, hardware_baseboard=None, ipfs_info=None, cpu_model=None, status=None, cpu_family=None, cpu_frequency=None, owner=None, operating_system_uptime=None, connection_url=None, memory=None, processors=None, cpu_logical_count=None, hardware_firmware=None, cpu_physical_cores=None, public_key=None, operating_system=None, local_vars_configuration=None):  # noqa: E501
