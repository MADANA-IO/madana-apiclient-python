...
class JsonNodeInfo(object):
    ...
    def __init__(self, cpu_physical_cores=None, public_key=None, hardware_baseboard=None, operating_system=None, connection_url=None, processors=None, cpu_family=None, memory=None, hardware_firmware=None, operating_system_uptime=None, cpu_frequency=None, owner=None, cpu_model=None, cpu_logical_count=None, ipfs_info=None, status=None, local_vars_configuration=None):  # noqa: E501
