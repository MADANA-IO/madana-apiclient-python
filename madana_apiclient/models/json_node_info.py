...
class JsonNodeInfo(object):
    ...
    def __init__(self, cpu_model=None, cpu_logical_count=None, owner=None, operating_system_uptime=None, operating_system=None, public_key=None, connection_url=None, memory=None, hardware_baseboard=None, hardware_firmware=None, cpu_frequency=None, status=None, ipfs_info=None, processors=None, cpu_family=None, cpu_physical_cores=None, local_vars_configuration=None):  # noqa: E501
