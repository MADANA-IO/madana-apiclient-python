...
class JsonNodeInfo(object):
    ...
    def __init__(self, operating_system_uptime=None, cpu_family=None, public_key=None, processors=None, owner=None, status=None, ipfs_info=None, cpu_logical_count=None, hardware_baseboard=None, hardware_firmware=None, cpu_physical_cores=None, cpu_frequency=None, operating_system=None, memory=None, cpu_model=None, connection_url=None, local_vars_configuration=None):  # noqa: E501
