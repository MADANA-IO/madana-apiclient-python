...
class JsonNodeInfo(object):
    ...
    def __init__(self, ipfs_info=None, cpu_frequency=None, operating_system=None, cpu_physical_cores=None, cpu_family=None, memory=None, owner=None, processors=None, connection_url=None, cpu_model=None, cpu_logical_count=None, hardware_firmware=None, operating_system_uptime=None, status=None, public_key=None, hardware_baseboard=None, local_vars_configuration=None):  # noqa: E501
