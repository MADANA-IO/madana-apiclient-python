...
class JsonMDNUserAllOf(object):
    ...
    def __init__(self, first_name=None, mail=None, credentials=None, guid=None, settings=None, last_name=None, social_accounts=None, local_vars_configuration=None):  # noqa: E501
