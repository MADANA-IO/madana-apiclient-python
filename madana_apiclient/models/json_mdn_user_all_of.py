...
class JsonMDNUserAllOf(object):
    ...
    def __init__(self, last_name=None, settings=None, credentials=None, first_name=None, guid=None, mail=None, social_accounts=None, local_vars_configuration=None):  # noqa: E501
