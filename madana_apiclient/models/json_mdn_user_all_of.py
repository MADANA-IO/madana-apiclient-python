...
class JsonMDNUserAllOf(object):
    ...
    def __init__(self, mail=None, guid=None, last_name=None, social_accounts=None, settings=None, first_name=None, credentials=None, local_vars_configuration=None):  # noqa: E501
