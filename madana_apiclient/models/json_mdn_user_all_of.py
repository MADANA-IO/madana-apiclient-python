...
class JsonMDNUserAllOf(object):
    ...
    def __init__(self, credentials=None, guid=None, social_accounts=None, mail=None, settings=None, last_name=None, first_name=None, local_vars_configuration=None):  # noqa: E501
