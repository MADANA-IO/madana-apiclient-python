...
class JsonMDNUserAllOf(object):
    ...
    def __init__(self, first_name=None, mail=None, last_name=None, social_accounts=None, settings=None, credentials=None, guid=None, local_vars_configuration=None):  # noqa: E501
