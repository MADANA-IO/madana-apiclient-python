...
class JsonMDNUserAllOf(object):
    ...
    def __init__(self, guid=None, first_name=None, last_name=None, credentials=None, social_accounts=None, mail=None, settings=None, local_vars_configuration=None):  # noqa: E501
