...
class JsonMDNUserAllOf(object):
    ...
    def __init__(self, last_name=None, mail=None, guid=None, credentials=None, social_accounts=None, first_name=None, settings=None, local_vars_configuration=None):  # noqa: E501
