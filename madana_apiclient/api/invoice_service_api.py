...
class InvoiceServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_billing_portal_url(
            self,
            **kwargs
        ):
            """get_billing_portal_url  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_billing_portal_url(async_req=True)
            >>> result = thread.get()
        ...
        self.get_billing_portal_url = Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [],
                'endpoint_path': '/invoices/portal',
                'operation_id': 'get_billing_portal_url',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__get_billing_portal_url
        )
