    ...
    def __init__(self, api_client=None):
        ...
        def __redist_test(
            ...
            **kwargs
            ...
            """redist_test  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.redist_test(async_req=True)
            >>> result = thread.get()
        ...
        self.redist_test = Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [],
                'endpoint_path': '/enclaves/test/redis',
                'operation_id': 'redist_test',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
