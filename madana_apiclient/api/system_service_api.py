...
class SystemServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_all_objects = Endpoint(
            ...
            callable=__get_all_objects
        )

        def __get_application2(
            self,
            **kwargs
        ):
            ...
            >>> thread = api.get_application2(async_req=True)
            >>> result = thread.get()
        ...
        self.get_application2 = Endpoint(
            settings={
                'response_type': ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)},),
                'auth': [],
                'endpoint_path': '/system/usage',
                'operation_id': 'get_application2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
