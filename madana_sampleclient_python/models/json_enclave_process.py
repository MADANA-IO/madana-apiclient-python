...
class JsonEnclaveProcess(object):
    ...
    def __init__(self, remote_control_server=None, process=None, signer_ident=None, internal_attesation_server=None, attestation_server=None, internal_remote_control_server=None, wg_interface=None, ending_time=None, environment=None, internal_ident=None, console_output=None, wireguard_public_key=None, startup_time=None, enclave_ident=None, status=None, local_vars_configuration=None):  # noqa: E501
