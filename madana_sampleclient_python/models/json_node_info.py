...
class JsonNodeInfo(object):
    ...
    def __init__(self, hardware_baseboard=None, public_key=None, memory=None, processors=None, cpu_logical_count=None, connection_url=None, operating_system=None, cpu_physical_cores=None, status=None, operating_system_uptime=None, cpu_model=None, owner=None, cpu_family=None, cpu_frequency=None, hardware_firmware=None, local_vars_configuration=None):  # noqa: E501
