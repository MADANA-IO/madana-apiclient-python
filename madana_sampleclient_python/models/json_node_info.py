...
class JsonNodeInfo(object):
    ...
    def __init__(self, cpu_model=None, hardware_firmware=None, cpu_family=None, memory=None, cpu_logical_count=None, hardware_baseboard=None, operating_system=None, public_key=None, processors=None, ipfs_info=None, cpu_frequency=None, operating_system_uptime=None, owner=None, cpu_physical_cores=None, status=None, connection_url=None, local_vars_configuration=None):  # noqa: E501
