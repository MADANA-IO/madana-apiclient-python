...
from madana_sampleclient_python.models.xml_ns0_enclave_running_attestation_approval import XmlNs0EnclaveRunningAttestationApproval  # noqa: E501
...
class TestXmlNs0EnclaveRunningAttestationApproval(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = madana_sampleclient_python.models.xml_ns0_enclave_running_attestation_approval.XmlNs0EnclaveRunningAttestationApproval()  # noqa: E501
        if include_optional :
            return XmlNs0EnclaveRunningAttestationApproval(
                approved = '0'
            )
        else :
            return XmlNs0EnclaveRunningAttestationApproval(
