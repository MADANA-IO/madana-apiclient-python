    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return JsonEnclaveProcess(
                ...
                environment = {size=..., name=..., uuid=..., rootHashOffset=..., content=[..., ...], defaultRunConfiguration={args=[..., ...], disk_config=[{roothash=..., disk=..., roothash_offset=12345, readonly=true}, {roothash=..., disk=..., roothash_offset=12345, readonly=true}], environment={property1=..., property2=...}, run=...}, ipfsHash=..., roothash=..., published=true, packages=[..., ...], description=...}, 
