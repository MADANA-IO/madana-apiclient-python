    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return JsonEnclaveProcess(
                environment = {packages=[..., ...], published=true, ipfsHash=..., roothash=..., defaultRunConfiguration={environment={property1=..., property2=...}, args=[..., ...], disk_config=[{readonly=true, disk=..., roothash=..., roothash_offset=12345}, {readonly=true, disk=..., roothash=..., roothash_offset=12345}], run=...}, description=..., rootHashOffset=..., content=[..., ...], size=..., uuid=..., name=...}, 
                wireguard_public_key = '0', 
                startup_cmd = '0', 
                status = '0', 
                enclave_inputstream = {}, 
                process = {outputStream={}, inputStream={}, alive=true, errorStream={}}, 
                console_output = '0', 
                internal_ident = '0', 
