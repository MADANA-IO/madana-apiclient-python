    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return JsonEnclaveProcess(
                ...
                ending_time = '0', 
                wg_interface = null, 
                process = {inputStream={}, errorStream={}, alive=true, outputStream={}}, 
                public_ident = '0', 
                console_output = '0', 
                environment = {ipfsHash=..., published=true, packages=[..., ...], content=[..., ...], uuid=..., rootHashOffset=..., roothash=..., name=..., defaultRunConfiguration={run=..., disk_config=[{readonly=true, disk=..., roothash=..., roothash_offset=12345}, {readonly=true, disk=..., roothash=..., roothash_offset=12345}], environment={property1=..., property2=...}, args=[..., ...]}, size=..., description=...}
            )
        else :
            return JsonEnclaveProcess(
        )
