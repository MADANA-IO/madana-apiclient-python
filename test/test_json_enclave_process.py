    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return JsonEnclaveProcess(
                environment = {ipfsHash=..., size=..., content=[..., ...], roothash=..., packages=[..., ...], name=..., rootHashOffset=..., defaultRunConfiguration={run=..., disk_config=[{roothash_offset=12345, readonly=true, roothash=..., disk=...}, {roothash_offset=12345, readonly=true, roothash=..., disk=...}], environment={property1=..., property2=...}, args=[..., ...]}, description=..., published=true, uuid=...}, 
                internal_attesation_server = '0', 
                process = {inputStream={}, errorStream={}, outputStream={}, alive=true}, 
                console_output = '0', 
                status = '0', 
