    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return JsonEnclaveProcess(
                ...
                startup_time = '0', 
                console_output = '0', 
                environment = {roothash=..., name=..., rootHashOffset=..., published=true, ipfsHash=..., uuid=..., content=[..., ...], size=..., description=..., defaultRunConfiguration={run=..., environment={property1=..., property2=...}, args=[..., ...], disk_config=[{disk=..., roothash_offset=12345, roothash=..., readonly=true}, {disk=..., roothash_offset=12345, roothash=..., readonly=true}]}, packages=[..., ...]}, 
