    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return JsonEnclaveProcess(
                ...
                environment = {name=..., content=[..., ...], roothash=..., defaultRunConfiguration={run=..., environment={property1=..., property2=...}, args=[..., ...], disk_config=[{roothash=..., roothash_offset=12345, readonly=true, disk=...}, {roothash=..., roothash_offset=12345, readonly=true, disk=...}]}, published=true, uuid=..., description=..., ipfsHash=..., packages=[..., ...], rootHashOffset=..., size=...}, 
                startup_time = '0', 
                startup_cmd = '0', 
                internal_ident = '0', 
                status = '0', 
