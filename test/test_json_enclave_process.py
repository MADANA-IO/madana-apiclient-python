...
from madana_sampleclient_python.models.json_enclave_process import JsonEnclaveProcess  # noqa: E501
...
class TestJsonEnclaveProcess(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = madana_sampleclient_python.models.json_enclave_process.JsonEnclaveProcess()  # noqa: E501
        if include_optional :
            return JsonEnclaveProcess(
                remote_control_server = '0', 
                process = {inputStream={}, alive=true, errorStream={}, outputStream={}}, 
                signer_ident = '0', 
                ...
                wg_interface = null, 
                ending_time = '0', 
                environment = {description=..., published=true, roothash=..., size=..., defaultRunConfiguration={environment={property1=..., property2=...}, args=[..., ...], run=..., disk_config=[{roothash=..., disk=..., roothash_offset=12345, readonly=true}, {roothash=..., disk=..., roothash_offset=12345, readonly=true}]}, ipfsHash=..., packages=[..., ...], rootHashOffset=..., name=..., uuid=..., content=[..., ...]}, 
                internal_ident = '0', 
                console_output = '0', 
