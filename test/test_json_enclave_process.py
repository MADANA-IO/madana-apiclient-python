    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return JsonEnclaveProcess(
                ...
                environment = {description=..., rootHashOffset=..., uuid=..., name=..., published=true, roothash=..., defaultRunConfiguration={run=..., environment={property1=..., property2=...}, args=[..., ...], disk_config=[{roothash_offset=12345, readonly=true, roothash=..., disk=...}, {roothash_offset=12345, readonly=true, roothash=..., disk=...}]}, size=..., content=[..., ...], packages=[..., ...], ipfsHash=...}, 
                process = {inputStream={}, outputStream={}, alive=true, errorStream={}}, 
                status = '0', 
                startup_cmd = '0', 
                enclave_inputstream = {}, 
                internal_ident = '0', 
