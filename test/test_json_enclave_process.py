    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return JsonEnclaveProcess(
                ...
                internal_ident = '0', 
                environment = {uuid=..., packages=[..., ...], content=[..., ...], roothash=..., description=..., defaultRunConfiguration={args=[..., ...], environment={property1=..., property2=...}, disk_config=[{roothash=..., readonly=true, roothash_offset=12345, disk=...}, {roothash=..., readonly=true, roothash_offset=12345, disk=...}], run=...}, ipfsHash=..., size=..., name=..., published=true, rootHashOffset=...}, 
                wireguard_server = '0', 
                ending_time = '0', 
