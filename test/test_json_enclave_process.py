    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return JsonEnclaveProcess(
                ending_time = '0', 
                process = {errorStream={}, inputStream={}, alive=true, outputStream={}}, 
                wireguard_server = '0', 
                startup_time = '0', 
                enclave_inputstream = {}, 
                ...
                internal_ident = '0', 
                startup_cmd = '0', 
                environment = {packages=[..., ...], defaultRunConfiguration={disk_config=[{roothash_offset=12345, roothash=..., disk=..., readonly=true}, {roothash_offset=12345, roothash=..., disk=..., readonly=true}], environment={property1=..., property2=...}, args=[..., ...], run=...}, name=..., content=[..., ...], size=..., ipfsHash=..., uuid=..., published=true, roothash=..., rootHashOffset=..., description=...}, 
                status = '0', 
