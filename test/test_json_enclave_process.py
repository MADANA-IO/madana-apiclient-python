    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return JsonEnclaveProcess(
                startup_time = '0', 
                environment = {uuid=..., description=..., defaultRunConfiguration={args=[..., ...], disk_config=[{disk=..., roothash=..., roothash_offset=12345, readonly=true}, {disk=..., roothash=..., roothash_offset=12345, readonly=true}], run=..., environment={property1=..., property2=...}}, rootHashOffset=..., ipfsHash=..., packages=[..., ...], published=true, roothash=..., name=..., content=[..., ...], size=...}, 
                ...
                process = {alive=true, outputStream={}, errorStream={}, inputStream={}}, 
