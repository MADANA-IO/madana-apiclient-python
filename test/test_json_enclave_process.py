    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return JsonEnclaveProcess(
                ...
                environment = {roothash=..., uuid=..., published=true, ipfsHash=..., packages=[..., ...], defaultRunConfiguration={args=[..., ...], run=..., disk_config=[{readonly=true, roothash=..., roothash_offset=12345, disk=...}, {readonly=true, roothash=..., roothash_offset=12345, disk=...}], environment={property1=..., property2=...}}, content=[..., ...], size=..., rootHashOffset=..., description=..., name=...}, 
                process = {outputStream={}, alive=true, inputStream={}, errorStream={}}, 
                ending_time = '0', 
                enclave_ident = '0', 
