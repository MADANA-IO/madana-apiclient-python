...
from madana_sampleclient_python.models.json_disk_config import JsonDiskConfig  # noqa: E501
from madana_sampleclient_python.rest import ApiException

class TestJsonDiskConfig(unittest.TestCase):
    """JsonDiskConfig unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = madana_sampleclient_python.models.json_disk_config.JsonDiskConfig()  # noqa: E501
        if include_optional :
            return JsonDiskConfig(
                roothash = '0', 
                disk = '0', 
                roothash_offset = 56, 
                readonly = True
