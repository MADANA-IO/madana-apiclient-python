...
globals()['JsonNetworkInterface'] = JsonNetworkInterface
globals()['JsonWireguardInterfaceAllOf'] = JsonWireguardInterfaceAllOf
...
class TestJsonWireguardInterface(unittest.TestCase):
    ...
    def testJsonWireguardInterface(self):
        ...
        # model = JsonWireguardInterface()  # noqa: E501
        pass
